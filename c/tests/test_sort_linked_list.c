...
Test_ptr should_q_sort_empty_linked_list(Test_ptr test)
{
  test->name = "should sort empty linked_list";
  ...
  quickSort_linked_list(linked_list, is_int_less_than);
  assert_linked_list_equal(linked_list, expected_ll, is_int_equal, test);

  return test;
}

Test_ptr should_q_sort_sorted_linked_list(Test_ptr test)
{
  test->name = "should sort sorted linked_list";
...
Test_ptr should_q_sort_unsorted_linked_list(Test_ptr test)
{
  test->name = "should sort unsorted linked_list";
...
void test_quickSort_linked_list(TestReport_ptr report)
{
  Test_Func tests[] = {
      should_q_sort_empty_linked_list,
      should_q_sort_sorted_linked_list,
      should_q_sort_unsorted_linked_list};

  run_tests("quickSort_linked_list()", tests, 3, report);
}
